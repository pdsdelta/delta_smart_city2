...
public class GestionMotionSensorVue extends javax.swing.JFrame {
	...
	public GestionMotionSensorVue() throws ClassNotFoundException, SQLException, UnknownHostException, IOException {
		...
		List<MotionSensor> lt = this.data.getAll();
	...
	private void initComponents() {
		...
		jLabel6.setBounds(83, 10, 589, 70);
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
		...
		try{
			...
			this.data.startConnection("172.31.249.22", 2400);
			if((result!=null)) {
				JOptionPane.showMessageDialog(null,"l'objet est bien ajouter");
				txtno.setText("");
				afficher();
			}else {
	...
	private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
		try { 
			if (JOptionPane.showConfirmDialog (null,"confirmer la modification","modification",
				...
				captor.setActive(Boolean.getBoolean(txtbr.getSelectedItem().toString()));
	...
	private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
		try {
			...
			if (model.getRowCount () == 0){JOptionPane.showMessageDialog(null,"il y a aucun Detecteur");
