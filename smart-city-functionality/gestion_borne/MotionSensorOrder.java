...
import user.Users;
public class MotionSensorOrder {

	private int numOrder;
	private Users user;
	
	public MotionSensorOrder(int numOrder, Users user) {
	...
	public String generateJson() throws JsonProcessingException {
		...
		switch(this.numOrder){
			case 1 :
				...
				res  ="{request:{ operation_type: CREATE_SENSOR, target: MotionSensor , longitude: "+longitude + ", latitude: "+ latitude + ", isActive : "+ login +", status : "+ pass +", numero : "+ profil +", city : "+idCity+"}} " ;
				break;
			case 2 :
				res ="{request:{ operation_type: ALL_SENSOR, target: MotionSensor }}" ;
				break;
			case 3 :
				...
				res ="{request:{ operation_type: SELECT_SENSOR, target: MotionSensor , login: ";
				res = res + newUserRead + "}}" ;
				break;
			case 4 :
				...
				res  ="{request:{ operation_type: UPDATE_SENSOR, target: MotionSensor , to_modify: "+choixFinal + ", modification: "+ "\"" +newthingUpdate + "\"" + ", login : "+ userUpdate +"}} " ;
			...
			case 5:
				...
				res ="{request:{ operation_type: DELETE_SENSOR, target: MotionSensor , login: ";
